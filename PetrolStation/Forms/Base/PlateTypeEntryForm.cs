...
namespace PetrolStation.Forms.Base
{
	public partial class PlateTypeEntryForm : General.SuperForm
	{
		...
		/// Model
		/// </summary>
		Common.BLL.Entity.PetrolStation.Base__PlateType	model;
		#endregion
		...
		/// Constructor
		/// </summary>
		public PlateTypeEntryForm (Common.BLL.Entity.PetrolStation.Base__PlateType model = null)
		{
			InitializeComponent ();
		...
		{
			if (null == model)
				model	= new Common.BLL.Entity.PetrolStation.Base__PlateType ();
			else
			{
			...
			// Fill Controls
			BaseBLL.General.FormModelHelper<Common.BLL.Entity.PetrolStation.Base__PlateType>.fillControl (dataGroupBox, model);
		}
		...
		void saveButton_Click (object sender, EventArgs e)
		{
			...
			{ 
				// Fill Model
				BaseBLL.General.FormModelHelper<Common.BLL.Entity.PetrolStation.Base__PlateType>.fillModel (dataGroupBox, model);

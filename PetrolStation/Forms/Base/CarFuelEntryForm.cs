...
namespace PetrolStation.Forms.Base
{
	public partial class CarFuelEntryForm  : General.SuperForm
	{
		...
		/// Model
		/// </summary>
		Common.BLL.Entity.PetrolStation.Base__CarFuel model;
		...
		/// Constructor	
		/// </summary>
		public CarFuelEntryForm (Common.BLL.Entity.PetrolStation.Base__CarFuel model = null)
		{
			InitializeComponent ();
		...
		{
			if (null == model)
				model = new Common.BLL.Entity.PetrolStation.Base__CarFuel();
			else
			{
			...
			//Fill Controls
			BaseBLL.General.FormModelHelper<Common.BLL.Entity.PetrolStation.Base__CarFuel>.fillControl	(dataGroupBox,model);
		}
		...
		private void saveButton_Click (object sender, EventArgs e)
		{
			...
			{ 
				// Fill Model
				BaseBLL.General.FormModelHelper<Common.BLL.Entity.PetrolStation.Base__CarFuel>.fillModel (dataGroupBox, model);

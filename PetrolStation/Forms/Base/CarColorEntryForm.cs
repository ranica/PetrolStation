...
namespace PetrolStation.Forms.Base
{
	public partial class CarColorEntryForm : General.SuperForm
	{
		...
		/// Model
		/// </summary>
		Common.BLL.Entity.PetrolStation.Base__CarColor	model;
		#endregion
		...
		/// Constructor
		/// </summary>
		public CarColorEntryForm (Common.BLL.Entity.PetrolStation.Base__CarColor model = null)
		{
			InitializeComponent ();
		...
		{
			if (null == model)
				model	= new Common.BLL.Entity.PetrolStation.Base__CarColor ();
			else
			{
			...
			// Fill Controls
			BaseBLL.General.FormModelHelper<Common.BLL.Entity.PetrolStation.Base__CarColor>.fillControl (dataGroupBox, model);			
		}
		...
		void saveButton_Click (object sender, EventArgs e)
		{
			...
			{ 
				// Fill Model
				BaseBLL.General.FormModelHelper<Common.BLL.Entity.PetrolStation.Base__CarColor>.fillModel (dataGroupBox, model);
		...
		private void saveRecord ()
		{
			...
			Common.BLL.Logic.PetrolStation.Base__CarColor	lCarColor	= new Common.BLL.Logic.PetrolStation.Base__CarColor (Common.Enum.EDatabase.PetrolStation);
			//Common.BLL.Entity.PetrolStation.Base__CarColor	carColor	= new Common.BLL.Entity.PetrolStation.Base__CarColor ();

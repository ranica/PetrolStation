...
namespace PetrolStation.Forms.Base
{
	public partial class CarLevelEntryForm : General.SuperForm
	{
		...
		/// Model
		/// </summary>
		Common.BLL.Entity.PetrolStation.Base__CarLevel	model;
		#endregion
		...
		/// Constructor
		/// </summary>
		public CarLevelEntryForm (Common.BLL.Entity.PetrolStation.Base__CarLevel model = null)
		{
			InitializeComponent ();
		...
		{
			if (null == model)
				model	= new Common.BLL.Entity.PetrolStation.Base__CarLevel ();
			else
			{
			...
			// Fill Controls
			BaseBLL.General.FormModelHelper<Common.BLL.Entity.PetrolStation.Base__CarLevel>.fillControl (dataGroupBox, model);
		}
		...
		void saveButton_Click (object sender, EventArgs e)
		{
			...
			{ 
				// Fill Model
				BaseBLL.General.FormModelHelper<Common.BLL.Entity.PetrolStation.Base__CarLevel>.fillModel (dataGroupBox, model);

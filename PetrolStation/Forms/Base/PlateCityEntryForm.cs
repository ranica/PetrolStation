...
namespace PetrolStation.Forms.Base
{
	public partial class PlateCityEntryForm	: General.SuperForm
	{
		...
		/// Model
		/// </summary>
		Common.BLL.Entity.PetrolStation.Base__PlateCity	model;
		#endregion
		...
		/// Constructor
		/// </summary>
		public PlateCityEntryForm (Common.BLL.Entity.PetrolStation.Base__PlateCity model = null)
		{
			InitializeComponent ();
		...
		{
			if (null == model)
				model	= new Common.BLL.Entity.PetrolStation.Base__PlateCity ();
			else
			{
			...
			// Fill Controls
			BaseBLL.General.FormModelHelper<Common.BLL.Entity.PetrolStation.Base__PlateCity>.fillControl (dataGroupBox, model);
		}
		...
		void saveButton_Click (object sender, EventArgs e)
		{
			...
			{ 
				// Fill Model
				BaseBLL.General.FormModelHelper<Common.BLL.Entity.PetrolStation.Base__PlateCity>.fillModel (dataGroupBox, model);

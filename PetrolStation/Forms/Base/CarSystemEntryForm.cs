...
namespace PetrolStation.Forms.Base
{
	public partial class CarSystemEntryForm : General.SuperForm
	{
		...
		/// Model
		/// </summary>
		Common.BLL.Entity.PetrolStation.Base__CarSystem		model;
		#endregion
		...
		/// Constructor
		/// </summary>
		public CarSystemEntryForm (Common.BLL.Entity.PetrolStation.Base__CarSystem model = null)
		{
			InitializeComponent ();
		...
		{
			if (null == model)
				model	= new Common.BLL.Entity.PetrolStation.Base__CarSystem ();
			else
			{
				// Load model data from db
				Common.BLL.Logic.PetrolStation.Base__CarSystem	lCarModel	= new Common.BLL.Logic.PetrolStation.Base__CarSystem(Common.Enum.EDatabase.PetrolStation);
			...
			// Fill Controls
			BaseBLL.General.FormModelHelper<Common.BLL.Entity.PetrolStation.Base__CarSystem>.fillControl (dataGroupBox, model);
		}
		...
		void saveButton_Click (object sender, EventArgs e)
		{
			...
			{ 
				// Fill Model
				BaseBLL.General.FormModelHelper<Common.BLL.Entity.PetrolStation.Base__CarSystem>.fillModel (dataGroupBox, model);

...
namespace PetrolStation.Forms.Forms
{
	public partial class ExistenceCustomerForm : General.SuperForm
	{
		...
		/// Model
		/// </summary>
		Common.BLL.Entity.PetrolStation.Owner	model;
		...
		{
			model 	= new Common.BLL.Entity.PetrolStation.Owner ()
			{
			...
			{
				// Fill Controls
				BaseBLL.General.FormModelHelper<Common.BLL.Entity.PetrolStation.Owner>.fillControl (ownerDataGroupBox, model);	

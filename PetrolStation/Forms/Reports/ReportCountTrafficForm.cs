...
{
    public partial class ReportCountTrafficForm : General.SuperForm
    {
        #region Variables
        ...
        private void tryToReadTraffic()
        {
            ...
            if (ExtensionsDateTime.isValidDate(dateStart) && ExtensionsDateTime.isValidDate(dateEnd))
            {
                ...
                if (!_selectItem)
                {
                    loadCountTraffic(begin_date, end_date);
                }
            ...
            try
            {
                ...
                if (ExtensionsDateTime.isValidDate(dateStart) && ExtensionsDateTime.isValidDate(dateEnd))
                {
                    ...
                    else if (typeComboBox.SelectedIndex == 1)
                    {
                        ...
                        {
                            LoadCountTrafficByNationalCode(begin_date, end_date, nationalcode);
                        }
                        else
                        {
                    ...
                    else if (typeComboBox.SelectedIndex == 2)
                    {
                        ...
                        if (opResult.status == BaseDAL.Base.EnumCommandStatus.success)
                        {
                            loadCountTrafficByPlate(begin_date, end_date, plate);
                        }
                        else
                            MessageBox.Show(opResult.model.ToString(), "اخطار", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    }
		...
		private void loadCountTraffic(DateTime begindate, DateTime enddate)
        {           
            int PI;
            int PS;
            try
            {
                ...
                //{
                    ...
                    CommandResult opResult = lTraffic.loadTrafficCount(begindate, enddate, PI, PS, Common.GlobalData.UserManager.currentUser.id);
                    ...
                    countTraffic.Dock = DockStyle.Fill;
                    #endregion
        ...
        private void LoadCountTrafficByNationalCode(DateTime begindate, DateTime enddate, string nationalcode)
        {
            int PI;
            int PS;
            try
            {
                ...
                //{
                    ...
                    CommandResult opResult = lTraffic.loadTCByNC(begindate, enddate, nationalcode, PI, PS, Common.GlobalData.UserManager.currentUser.id);
        ...
        private void loadCountTrafficByPlate(DateTime begindate, DateTime enddate, string plate)
        {
            int PI;
            int PS;
            try
            {
                ...
                CommandResult opResult = lTraffic.loadTCByP(begindate, enddate, plate, PI, PS, Common.GlobalData.UserManager.currentUser.id);
            ...
            //CommandResult opResult = lTraffic.loadReportTrafficCountByPlate(begindate, enddate, plate, PI, PS, Common.GlobalData.UserManager.currentUser.id);
            //DataTable resultData = opResult.model as DataTable;
            //countTabPage.Controls.Clear();
            //UserControls.CountTrafficUserControl countTraffic = new UserControls.CountTrafficUserControl(resultData);
            //countTabPage.Controls.Add(countTraffic);

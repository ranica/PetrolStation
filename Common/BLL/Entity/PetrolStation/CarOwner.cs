...
//
	...
	#region Referenced Property - Car
		...
		{ 
			...
			logic	= new BLL.Logic.PetrolStation.Car (Common.Enum.EDatabase.PetrolStation);
			logic.read (entity);
		...
		[BaseBLL.Base.Field(nullable=false,sqlDBType=System.Data.SqlDbType.Int,primary=false,usage=BaseBLL.Base.EnumUsage.read | BaseBLL.Base.EnumUsage.update | BaseBLL.Base.EnumUsage.create,foreignLogicType=typeof (BLL.Logic.PetrolStation.Owner),foreignField="id")]
...
//
	...
	#region Referenced Property - Owner
		...
		{ 
			...
			entity	= new BLL.Entity.PetrolStation.Owner () { id = ownerId };
			logic	= new BLL.Logic.PetrolStation.Owner (Common.Enum.EDatabase.PetrolStation);
			logic.read (entity);

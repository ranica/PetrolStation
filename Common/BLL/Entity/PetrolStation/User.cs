...
//
	...
	#region Relation - Base__CarColor (Has-Many relation)
		...
		public void loadBase__CarColor_insertedById (int pageIndex = -1, int pageSize = 100)
		{
			...
			BLL.Logic.PetrolStation.Base__CarColor	logic	= new BLL.Logic.PetrolStation.Base__CarColor (Common.Enum.EDatabase.PetrolStation);
			if (pageIndex == -1)
...
//
	...
	#region Relation - CarTag (Has-Many relation)
		...
		public void loadCarTag_insertedById (int pageIndex = -1, int pageSize = 100)
		{
			...
			BLL.Logic.PetrolStation.CarTag	logic	= new BLL.Logic.PetrolStation.CarTag (Common.Enum.EDatabase.PetrolStation);
			if (pageIndex == -1)
				opResult	= logic.allData ("insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
			else
				opResult	= logic.allByPaging ( pageIndex, pageSize, "insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
...
//
	...
	#region Relation - Base__CarLevel (Has-Many relation)
		...
		public void loadBase__CarLevel_insertedById (int pageIndex = -1, int pageSize = 100)
		{
			...
			BLL.Logic.PetrolStation.Base__CarLevel	logic	= new BLL.Logic.PetrolStation.Base__CarLevel (Common.Enum.EDatabase.PetrolStation);
			if (pageIndex == -1)
				opResult	= logic.allData ("insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
			else
				opResult	= logic.allByPaging ( pageIndex, pageSize, "insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
...
//
	...
	#region Relation - Base__CarModel (Has-Many relation)
		...
		public void loadBase__CarModel_insertedById (int pageIndex = -1, int pageSize = 100)
		{
			...
			BLL.Logic.PetrolStation.Base__CarSystem	logic	= new BLL.Logic.PetrolStation.Base__CarSystem (Common.Enum.EDatabase.PetrolStation);
			if (pageIndex == -1)
				opResult	= logic.allData ("insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
			else
				opResult	= logic.allByPaging ( pageIndex, pageSize, "insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
...
//
	...
	#region Relation - Base__CarType (Has-Many relation)
		...
		public void loadBase__CarType_insertedById (int pageIndex = -1, int pageSize = 100)
		{
			...
			BLL.Logic.PetrolStation.Base__CarType	logic	= new BLL.Logic.PetrolStation.Base__CarType (Common.Enum.EDatabase.PetrolStation);
			if (pageIndex == -1)
				opResult	= logic.allData ("insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
			else
				opResult	= logic.allByPaging ( pageIndex, pageSize, "insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
...
//
	...
	#region Relation - CarOwner (Has-Many relation)
		...
		public void loadCarOwner_insertedById (int pageIndex = -1, int pageSize = 100)
		{
			...
			BLL.Logic.PetrolStation.CarOwner	logic	= new BLL.Logic.PetrolStation.CarOwner (Common.Enum.EDatabase.PetrolStation);
			if (pageIndex == -1)
				opResult	= logic.allData ("insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
			else
				opResult	= logic.allByPaging ( pageIndex, pageSize, "insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
...
//
	...
	#region Relation - Base__PlateCity (Has-Many relation)
		...
		public void loadBase__PlateCity_insertedById (int pageIndex = -1, int pageSize = 100)
		{
			...
			BLL.Logic.PetrolStation.Base__PlateCity	logic	= new BLL.Logic.PetrolStation.Base__PlateCity (Common.Enum.EDatabase.PetrolStation);
			if (pageIndex == -1)
				opResult	= logic.allData ("insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
			else
				opResult	= logic.allByPaging ( pageIndex, pageSize, "insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
...
//
	...
	#region Relation - Base__PlateType (Has-Many relation)
		...
		public void loadBase__PlateType_insertedById (int pageIndex = -1, int pageSize = 100)
		{
			...
			BLL.Logic.PetrolStation.Base__PlateType	logic	= new BLL.Logic.PetrolStation.Base__PlateType (Common.Enum.EDatabase.PetrolStation);
			if (pageIndex == -1)
				opResult	= logic.allData ("insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
			else
				opResult	= logic.allByPaging ( pageIndex, pageSize, "insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
...
//
	...
	#region Relation - Tag (Has-Many relation)
		...
		public void loadTag_insertedById (int pageIndex = -1, int pageSize = 100)
		{
			...
			BLL.Logic.PetrolStation.Tag	logic	= new BLL.Logic.PetrolStation.Tag (Common.Enum.EDatabase.PetrolStation);
			if (pageIndex == -1)
				opResult	= logic.allData ("insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
			else
				opResult	= logic.allByPaging ( pageIndex, pageSize, "insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
...
//
	...
	#region Relation - UHF (Has-Many relation)
		...
		public void loadUHF_insertedById (int pageIndex = -1, int pageSize = 100)
		{
			...
			BLL.Logic.PetrolStation.UHF	logic	= new BLL.Logic.PetrolStation.UHF (Common.Enum.EDatabase.PetrolStation);
			if (pageIndex == -1)
				opResult	= logic.allData ("insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
			else
				opResult	= logic.allByPaging ( pageIndex, pageSize, "insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
...
//
	...
	#region Relation - LegalOwner (Has-Many relation)
		...
		public void loadLegalOwner_insertedById (int pageIndex = -1, int pageSize = 100)
		{
			...
			BLL.Logic.PetrolStation.LegalOwner	logic	= new BLL.Logic.PetrolStation.LegalOwner (Common.Enum.EDatabase.PetrolStation);
			if (pageIndex == -1)
				opResult	= logic.allData ("insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
			else
				opResult	= logic.allByPaging ( pageIndex, pageSize, "insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
...
//
	...
	#region Relation - Owner (Has-Many relation)
		...
		public void loadOwner_insertedById (int pageIndex = -1, int pageSize = 100)
		{
			...
			BLL.Logic.PetrolStation.Owner	logic	= new BLL.Logic.PetrolStation.Owner (Common.Enum.EDatabase.PetrolStation);
			if (pageIndex == -1)
				opResult	= logic.allData ("insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
			else
				opResult	= logic.allByPaging ( pageIndex, pageSize, "insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
...
//
	...
	#region Relation - Plate (Has-Many relation)
		...
		public void loadPlate_insertedById (int pageIndex = -1, int pageSize = 100)
		{
			...
			BLL.Logic.PetrolStation.Plate	logic	= new BLL.Logic.PetrolStation.Plate (Common.Enum.EDatabase.PetrolStation);
			if (pageIndex == -1)
				opResult	= logic.allData ("insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
			else
				opResult	= logic.allByPaging ( pageIndex, pageSize, "insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
...
//
	...
	#region Relation - Base__CarFuel (Has-Many relation)
		...
		public void loadBase__CarFuel_insertedById (int pageIndex = -1, int pageSize = 100)
		{
			...
			BLL.Logic.PetrolStation.Base__CarFuel	logic	= new BLL.Logic.PetrolStation.Base__CarFuel (Common.Enum.EDatabase.PetrolStation);
			if (pageIndex == -1)
				opResult	= logic.allData ("insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));
			else
				opResult	= logic.allByPaging ( pageIndex, pageSize, "insertedById = @insertedById", "", false, true, new KeyValuePair ("@insertedById", id));

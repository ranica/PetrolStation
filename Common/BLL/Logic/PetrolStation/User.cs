...
{
	public class User : BaseBLL.Logic.Base<BLL.Entity.PetrolStation.User>
	{
		...
		public CommandResult getServiceUser ()
		{
			...
			Common.BLL.Entity.PetrolStation.User	user	= new Entity.PetrolStation.User ()
			{
		...
		/// <param name="user">User Model</param>
		/// <returns></returns>
		public CommandResult deleteUser (Entity.PetrolStation.User user)
		{
			CommandResult result;

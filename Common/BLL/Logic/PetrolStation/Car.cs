...
{
	public class Car : BaseBLL.Logic.Base<BLL.Entity.PetrolStation.Car>
	{
		#region Constants
		...
		/// <returns></returns>
		public CommandResult saveData ( Common.BLL.Entity.PetrolStation.Owner owner,
										Common.BLL.Entity.PetrolStation.Plate plate,
										Common.BLL.Entity.PetrolStation.User user)
										//Common.BLL.Entity.PetrolStation.Car car,
										
										//Common.BLL.Entity.PetrolStation.LegalOwner legalOwner)
		{
			CommandResult result;
